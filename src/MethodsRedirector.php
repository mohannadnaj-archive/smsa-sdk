...
trait MethodsRedirector
{
     ...
     */
    public static function DeliveredShipment()
    {
        $arguments = [];
    ...
    public static function addShip($passKey = null, $refNo = null, $sentDate = null, $idNo = null, $cName = null, $cntry = null, $cCity = null, $cZip = null, $cPOBox = null, $cMobile = null, $cTel1 = null, $cTel2 = null, $cAddr1 = null, $cAddr2 = null, $shipType = null, $PCs = null, $cEmail = null, $carrValue = null, $carrCurr = null, $codAmt = null, $weight = null, $custVal = null, $custCurr = null, $insrAmt = null, $insrCurr = null, $itemDesc = null, $sName = null, $sContact = null, $sAddr1 = null, $sAddr2 = null, $sCity = null, $sPhone = null, $sCntry = null, $prefDelvDate = null, $gpsPoints = null)
    {
        ...
        if (!is_null($cName)) {
            $arguments['cName'] = $cName;
        }

        if (!is_null($cntry)) {
            $arguments['cntry'] = $cntry;
        }

        if (!is_null($cCity)) {
            $arguments['cCity'] = $cCity;
        }
        ...
        if (!is_null($cPOBox)) {
            $arguments['cPOBox'] = $cPOBox;
        }

        if (!is_null($cMobile)) {
            $arguments['cMobile'] = $cMobile;
        }

        if (!is_null($cTel1)) {
            $arguments['cTel1'] = $cTel1;
        }

        if (!is_null($cTel2)) {
            $arguments['cTel2'] = $cTel2;
        }

        if (!is_null($cAddr1)) {
            $arguments['cAddr1'] = $cAddr1;
        }

        if (!is_null($cAddr2)) {
            $arguments['cAddr2'] = $cAddr2;
        }

        if (!is_null($shipType)) {
            $arguments['shipType'] = $shipType;
        }
        ...
        if (!is_null($cEmail)) {
            $arguments['cEmail'] = $cEmail;
        }

        if (!is_null($carrValue)) {
            $arguments['carrValue'] = $carrValue;
        }

        if (!is_null($carrCurr)) {
            $arguments['carrCurr'] = $carrCurr;
        }

        if (!is_null($codAmt)) {
            $arguments['codAmt'] = $codAmt;
        }
        ...
        if (!is_null($custCurr)) {
            $arguments['custCurr'] = $custCurr;
        }

        if (!is_null($insrAmt)) {
            $arguments['insrAmt'] = $insrAmt;
        }

        if (!is_null($insrCurr)) {
            $arguments['insrCurr'] = $insrCurr;
        }
        ...
        if (!is_null($sName)) {
            $arguments['sName'] = $sName;
        }

        if (!is_null($sContact)) {
            $arguments['sContact'] = $sContact;
        }

        if (!is_null($sAddr1)) {
            $arguments['sAddr1'] = $sAddr1;
        }

        if (!is_null($sAddr2)) {
            $arguments['sAddr2'] = $sAddr2;
        }

        if (!is_null($sCity)) {
            $arguments['sCity'] = $sCity;
        }

        if (!is_null($sPhone)) {
            $arguments['sPhone'] = $sPhone;
        }

        if (!is_null($sCntry)) {
            $arguments['sCntry'] = $sCntry;
        }

        if (!is_null($prefDelvDate)) {
            $arguments['prefDelvDate'] = $prefDelvDate;
        }
    ...
    public static function addShipPDF($passKey = null, $refNo = null, $sentDate = null, $idNo = null, $cName = null, $cntry = null, $cCity = null, $cZip = null, $cPOBox = null, $cMobile = null, $cTel1 = null, $cTel2 = null, $cAddr1 = null, $cAddr2 = null, $shipType = null, $PCs = null, $cEmail = null, $carrValue = null, $carrCurr = null, $codAmt = null, $weight = null, $custVal = null, $custCurr = null, $insrAmt = null, $insrCurr = null, $itemDesc = null, $sName = null, $sContact = null, $sAddr1 = null, $sAddr2 = null, $sCity = null, $sPhone = null, $sCntry = null, $prefDelvDate = null, $gpsPoints = null, $vatValue = null, $harmCode = null)
    {
        ...
        if (!is_null($vatValue)) {
            $arguments['vatValue'] = $vatValue;
        }

        if (!is_null($harmCode)) {
            $arguments['harmCode'] = $harmCode;
        }
     ...
     */
    public static function getAllRetailsTiming($passkey = null)
    {
        $arguments = [];
        $firstArgument = func_get_args()[0];
     ...
     */
    public static function getDeliveredShipments($passKey = null, $fromDate = null, $ToDate = null)
    {
        $arguments = [];
        $firstArgument = func_get_args()[0];
     ...
     */
    public static function getRTLRetailsTiming($cityCode = null, $passkey = null)
    {
        $arguments = [];
        $firstArgument = func_get_args()[0];
     ...
     */
    public static function getShipCharges($passKey = null, $shipCity = null, $shipCntry = null, $destCity = null, $destCntry = null, $shipType = null, $codAmt = null, $weight = null)
    {
        $arguments = [];
        $firstArgument = func_get_args()[0];
        ...
        if (!is_null($shipCity)) {
            $arguments['shipCity'] = $shipCity;
        }

        if (!is_null($shipCntry)) {
            $arguments['shipCntry'] = $shipCntry;
        }

        if (!is_null($destCity)) {
            $arguments['destCity'] = $destCity;
        }

        if (!is_null($destCntry)) {
            $arguments['destCntry'] = $destCntry;
        }
     ...
     */
    public static function getShipmentUpdates($rowId = null, $passKey = null)
    {
        $arguments = [];
        $firstArgument = func_get_args()[0];
     ...
     */
    public static function getTrack($awbNo = null, $passkey = null)
    {
        $arguments = [];
        $firstArgument = func_get_args()[0];
